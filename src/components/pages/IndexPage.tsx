    ...
    <div className="min-h-screen bg-background">
      ...
      <motion.section className="pt-40 pb-24 px-8" {...sectionAnimation}>
        <div className="max-w-5xl mx-auto text-center space-y-8">
          ...
          <p className="text-xl md:text-2xl font-light text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            We integrate physiological signals, behavioral patterns, and clinical
            knowledge to deliver individualized insights that support long-term
            health, resilience, and optimal aging.
          </p>
      ...
      >
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          <p className="text-lg font-light text-muted-foreground leading-relaxed text-center">
            Modern health requires more than occasional check-ups. Our platform
            continuously evaluates the body's core physiological systems —
            cardiovascular, autonomic, circadian and behavioral — transforming
            raw signals into actionable, clinically aligned insights.
          </p>
          <p className="text-lg font-light text-muted-foreground leading-relaxed text-center">
            We help individuals and clinicians identify early deviations,
            optimize recovery, and guide long-term longevity strategies with
            unprecedented precision.
          </p>
          <div className="pt-8 text-center text-sm font-light text-muted-foreground">
            Physiological Data → Clinical Interpretation → Personalized Actions →
            Long-term Outcomes
          </div>
        </div>
      </motion.section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="text-sm font-light text-muted-foreground leading-relaxed">
                Personalized longevity plans informed by real physiology, not
                generic advice.
              </p>
            </motion.div>
            <motion.div
            ...
            >
              ...
              <p className="text-sm font-light text-muted-foreground leading-relaxed">
                Objective, structured, longitudinal insights that enhance
                diagnostic precision and follow-up quality.
              </p>
            </motion.div>
            <motion.div
              className="p-8 border border-border/50 rounded-3xl bg-card/60 text-center"
            ...
            >
              ...
              />
              <h3 className="text-xl font-light text-primary mb-4">
                For Health Systems & Insurers
              </h3>
              <p className="text-sm font-light text-muted-foreground leading-relaxed">
                Scalable preventive monitoring, risk stratification, and
      ...
      >
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-sm md:text-base font-light text-muted-foreground text-center max-w-2xl mx-auto mb-12">
            Three holographic layers that turn continuous physiological signals
            into medically meaningful, human-centered intelligence.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <div className="relative z-10 mt-40">
                ...
                <p className="text-sm font-light text-muted-foreground leading-relaxed">
                  We securely collect signals from validated wearables, medical
                  devices and clinical inputs, then normalize them into a unified
                  health data model across sources and time.
                </p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="relative z-10 mt-40">
                ...
                <p className="text-sm font-light text-muted-foreground leading-relaxed mb-2">
                  Rule engines and medically-aligned AI models continuously
                  interpret patterns in cardiovascular, circadian and behavioral
                  signals to detect deviations and opportunities for intervention.
                </p>
                <p className="text-xs font-light text-muted-foreground leading-relaxed">
                  Every day your body repairs itself — we measure how effectively
                  that process is happening and where it can be improved.
                </p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="relative z-10 mt-40">
                ...
                <p className="text-sm font-light text-muted-foreground leading-relaxed mb-2">
                  A patient-facing mobile app and a professional web platform
                  deliver the right information to the right person — from
                  meaningful feedback for the individual to longitudinal views
                  for the physician.
                </p>
                <p className="text-xs font-light text-muted-foreground leading-relaxed">
                  We stay at your side continuously, turning complex data into
                  clear, actionable insights for both the user and the medical
                  team.
                </p>
              </div>
            </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="text-sm font-light text-muted-foreground leading-relaxed mb-3">
                  High-frequency data from validated biosensors: heart rhythm,
                  blood pressure, sleep architecture, and autonomic load.
                </p>
                <p className="text-sm font-light text-muted-foreground leading-relaxed">
                  Signals reveal how your body responds, adapts, and recovers in
                  real environments.
                </p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="text-sm font-light text-muted-foreground leading-relaxed mb-3">
                  Advanced chronobiological models quantify synchrony of internal
                  clocks — sleep-wake cycles, metabolic rhythms, and autonomic
                  balance.
                </p>
                <p className="text-sm font-light text-muted-foreground leading-relaxed">
                  Estimates your{" "}
                  <strong>biological age of circadian function</strong>, a
                  sensitive marker of healthspan and resilience.
                </p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="text-sm font-light text-muted-foreground leading-relaxed mb-3">
                  Converts unstructured symptoms, notes, and self-reports into
                  structured medical concepts.
                </p>
                <p className="text-sm font-light text-muted-foreground leading-relaxed">
                  Maps relevant patterns: cardiometabolic risks, lifestyle
                  stressors, inflammatory load, and recovery deficits.
                </p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="text-sm font-light text-muted-foreground leading-relaxed mb-3">
                  Synthesizes your physiological profile with evidence-based
                  medical guidelines to generate tailored recommendations.
                </p>
                <p className="text-sm font-light text-muted-foreground leading-relaxed">
                  Includes recovery strategies, movement protocols, stress
                  regulation, sleep optimization, and longevity interventions.
                </p>
              </div>
            </motion.div>
          </div>
        ...
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <div className="space-y-6">
            <p className="text-lg font-light text-muted-foreground leading-relaxed">
              Your biological age is not determined by years, but by how your
              internal systems function.
            </p>
            <p className="text-lg font-light text-muted-foreground leading-relaxed">
              Through chronobiological modeling, we evaluate the strength,
              regularity, and phase of your circadian rhythms — powerful
              predictors of long-term healthspan.
            </p>
            <p className="text-lg font-light text-muted-foreground leading-relaxed">
              A lower index corresponds to improved resilience, metabolic
              stability, cardiovascular efficiency, and mood regulation.
            </p>
          </div>
          <motion.div
      ...
      >
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <p className="text-lg font-light text-muted-foreground leading-relaxed text-center">
            Our platform provides clinicians with structured, longitudinal
            insights that are difficult to observe in sporadic visits.
          </p>
          <p className="text-lg font-light text-muted-foreground leading-relaxed text-center">
            By integrating physiological, behavioral, and chronobiological
            metrics, clinicians gain:
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-8 max-w-2xl mx-auto">
            <div className="flex items-start gap-3">
              <ArrowRight className="w-5 h-5 text-primary mt-1 flex-shrink-0" />
              <p className="text-sm font-light text-muted-foreground">
                Early detection of deviations before they manifest as symptoms.
              </p>
            </div>
            <div className="flex items-start gap-3">
              <ArrowRight className="w-5 h-5 text-primary mt-1 flex-shrink-0" />
              <p className="text-sm font-light text-muted-foreground">
                Clear visualization of patient-specific trends.
              </p>
            </div>
            <div className="flex items-start gap-3">
              <ArrowRight className="w-5 h-5 text-primary mt-1 flex-shrink-0" />
              <p className="text-sm font-light text-muted-foreground">
                Support for preventive decision-making and individualized care.
              </p>
            </div>
            <div className="flex items-start gap-3">
              <ArrowRight className="w-5 h-5 text-primary mt-1 flex-shrink-0" />
              <p className="text-sm font-light text-muted-foreground">
                Improved understanding of treatment adherence and response.
              </p>
            </div>
          </div>
          <p className="text-lg font-light text-muted-foreground leading-relaxed text-center pt-8">
            This bridges the gap between continuous biosensing and evidence-based
            clinical practice.
          </p>
        </div>
      </motion.section>
      ...
      >
        <div className="max-w-4xl mx-auto text-center space-y-6">
          ...
          <p className="text-lg font-light text-muted-foreground leading-relaxed">
            Every recommendation is derived from validated clinical guidelines,
            peer-reviewed literature, and established physiological models.
          </p>
          <p className="text-lg font-light text-muted-foreground leading-relaxed">
            Our system aligns with cardiometabolic, circadian, and behavioral
            health research, enabling interventions consistent with modern
            standards of preventive and longevity medicine.
          </p>
        </div>
      </motion.section>
      ...
      >
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <p className="text-lg font-light text-muted-foreground leading-relaxed text-center">
            Instead, we continuously evaluate how your body adapts over weeks
            and months, adjusting guidance based on your evolving biological
            patterns.
          </p>
      ...
      >
        <div className="max-w-4xl mx-auto text-center space-y-6">
          ...
          <p className="text-lg font-light text-muted-foreground leading-relaxed">
            We collaborate with medical professionals, research institutions, and
            technology partners to ensure safety, accuracy, and clinical
            relevance.
          </p>
          <p className="text-lg font-light text-muted-foreground leading-relaxed">
            Our mission is to integrate continuous sensing with medical-grade
            interpretation to support preventive care at scale.
          </p>
        </div>
      </motion.section>
      ...
      >
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <p className="text-xl font-light text-muted-foreground leading-relaxed">
            Unlock continuous insights into your health and discover how your
            body can age better, recover faster, and stay aligned with its
            natural rhythms.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-8">
            <Button
